...
(function(window, undefined) {"use strict";
    ...
    setTimeout = window.setTimeout || setTimeout, clearTimeout = window.clearTimeout || clearTimeout, setInterval = window.setInterval || setInterval, History = window.History = window.History || {};
        ...
        // Native pushState Implementation
            ...
            */
            ...
            History.onPopState = function(event, extra) {
                ...
                // Fire Our Event, if it wasn't manually triggered
                // https://github.com/rroesler/history.js/commit/7ed23c3fa967d5171190047a331b99e09321d350
                if (!wasExpected) {
                    History.Adapter.trigger(window, 'statechange');
                }
                // console.log("History.js: wasExpected", wasExpected);
                History.busy(false);
